...
$.extend(true, systemDictionary, {
    ...
    showresult: {
        ...
        de: 'Anzeige Ergebnis',
        ru: 'Результат',
        pt: 'Resultado da exposição',
        nl: 'Resultaat tonen',
        fr: 'Afficher le résultat',
        it: 'Visualizzazione del risultato',
        es: 'Resultado de visualización',
        pl: 'Wynik wyświetlania',
        uk: 'Результати пошуку',
        'zh-cn': '显示结果',
    },
    showabbreviation: {
        en: 'Display abbreviation',
        de: 'Abkürzung anzeigen',
        ru: 'Отображение аббревиатуры',
        pt: 'Abreviatura de exibição',
        nl: 'Afkorting weergeven',
        fr: "Afficher l'abréviation",
        it: 'Visualizzazione abbreviazione',
        es: 'Pantalla abreviatura',
        pl: 'Pokaż skrót',
        uk: 'Розширення екрану',
        'zh-cn': '显示缩略语',
    },
    showweekday: {
        en: 'Display weekday',
        ...
        nl: 'Weekdag weergeven',
        fr: 'Affichage en semaine',
        it: 'Visualizza giorno della settimana',
        es: 'Mostrar semanario',
        pl: 'Wyświetl dzień tygodnia',
        uk: 'День відкритих дверей',
        'zh-cn': '显示工作日',
    },
    group_leagues: {
        en: 'Group',
    ...
    'oid-allmatches': {
        ...
        pt: 'ID allmatches',
        nl: 'ID allmatches',
        fr: 'NUMÉRO allmatches',
        it: 'ID allmatches',
        es: 'ID allmatches',
        pl: 'ID allmatches',
        uk: "ІМ'Я allmatches",
        'zh-cn': '身份证 allmatches',
    },
    'oid-currgameday': {
        en: 'ID currgameday',
        de: 'ID currgameday',
        ...
        pt: 'ID currgameday',
        nl: 'ID currgameday',
        fr: 'NUMÉRO currgameday',
        it: 'ID currgameday',
        es: 'ID currgameday',
        pl: 'ID currgameday',
        uk: "ІМ'Я currgameday",
        'zh-cn': '身份证 currgameday',
    },
    showgameday: {
        en: 'Gameday',
        de: 'Spieltag',
    ...
    showgamedaycount: {
        en: 'Number of match days',
        de: 'Anzahl der Spieltage',
        ru: 'Количество дней матча',
        pt: 'Número de dias de jogo',
        nl: 'Aantal wedstrijddagen',
        fr: 'Nombre de jours de match',
        it: 'Numero di giorni di partita',
        es: 'Número de días de partido',
        pl: 'Liczba dni meczu',
        uk: 'Кількість днів матчу',
        'zh-cn': '比赛天数',
    },
    shortname: {
        en: 'Short name',
    ...
    showtrend: {
        ...
        de: 'Trend anzeigen',
        ru: 'Тенденция',
        pt: 'Mostrar tendência',
        nl: 'Trend tonen',
        fr: 'Afficher la tendance',
        it: 'Mostra trend',
    ...
    group_icons: {
        ...
        de: 'Trend icons',
        ru: 'Иконы тренда',
        pt: 'Ícones de tendência',
        nl: 'Trendpictogrammen',
        fr: 'Icônes de tendance',
        it: 'Icone di tendenza',
        es: 'Iconos de tendencia',
        pl: 'Ikony trendu',
        uk: 'Модні ікони',
        'zh-cn': '趋势图标',
    },
    iconup: {
        ...
        de: 'Trend nach oben',
        ru: 'Отклонение вверх',
        pt: 'Tendência para cima',
        nl: 'Trend omhoog',
        fr: 'Tendance à la hausse',
        it: "Tendenza verso l'alto",
        es: 'Tendencia hacia arriba',
        pl: 'Trend w górę',
        uk: 'Тенденції',
        'zh-cn': '上升趋势',
    },
    icondn: {
        ...
        de: 'Abwärtstrend',
        ru: 'Внизу',
        pt: 'Tendência para baixo',
        nl: 'Dalende trend',
        fr: 'Tendances à la baisse',
        it: 'Tendenza verso il basso',
        es: 'Tendencia descendente',
        pl: 'Tendencja spadkowa',
        uk: 'Важкий тренд',
        'zh-cn': '向下趋势',
    },
    iconst: {
        en: 'Trend unchanged',
        de: 'Trend unverändert',
        ru: 'Тренд без изменений',
        pt: 'Tendência inalterada',
        nl: 'Ontwikkeling ongewijzigd',
        fr: 'Évolution inchangée',
        it: 'Tendenze invariate',
        es: 'Tendencia sin cambios',
        pl: 'Trend bez zmian',
        uk: 'Тенденції без змін',
        'zh-cn': '趋势不变',
    },
    lastgamecount: {
        en: 'Last matchday',
        de: 'Letzter Spieltag',
        ru: 'Последний день матча',
        pt: 'Último dia do jogo',
        nl: 'Laatste wedstrijddag',
        fr: 'Dernier jour de rencontre',
        it: 'Ultimo giorno di partita',
        es: 'Último partido',
        pl: 'Ostatni mecz',
        uk: 'Останній збіг',
        'zh-cn': '上一个匹配日',
    ...
    highlightontop: {
        en: 'Highlight at the beginning',
        de: 'Highlight am Anfang',
        ru: 'Основной момент в начале',
        pt: 'Destaque no início',
        nl: 'Oplichten bij het begin',
        fr: 'Mettre en évidence au début',
        it: "In evidenza all'inizio",
        es: 'Destacar al principio',
        pl: 'Podświetl na początku',
        uk: 'Виділити на початку',
        'zh-cn': '开头突出',
    },
    maxcount: {
        en: 'Maximum number',
        ...
        it: 'Numero massimo',
        es: 'Número máximo',
        pl: 'Maksymalna liczba',
        uk: 'Максимальна кількість',
        'zh-cn': '最大数目',
    },
    sort: {
        en: 'Sorted',
    ...
    showonlyhighlight: {
        en: 'Show highlights only',
        de: 'Nur Highlights anzeigen',
        ru: 'Показать только',
        pt: 'Mostrar apenas destaques',
        nl: 'Alleen hoogtepunten tonen',
        fr: 'Afficher uniquement les faits saillants',
        it: 'Mostra solo i punti salienti',
        es: 'Show highlights sólo',
        pl: 'Pokaż tylko podświetlenia',
        uk: 'Показати тільки',
        'zh-cn': '只显示突出显示',
    },
    'oid-goalgetters': {
        ...
        pt: 'ID goalgetters',
        nl: 'ID goalgetters',
        fr: 'NUMÉRO goalgetters',
        it: 'ID goalgetters',
        es: 'ID goalgetters',
        pl: 'ID goalgetters',
        uk: "ІМ'Я goalgetters",
        'zh-cn': '身份证 goalgetters',
    },
    xxx: {},
});
